...
#'visibility_periods_used', 'astrometric_sigma5d_max', 'matched_transits',
...
#'scan_direction_mean_k2', 'scan_direction_mean_k3', 'scan_direction_mean_k4',
#'duplicated_source',
...
#'phot_bp_n_blended_transits', 'phot_rp_n_contaminated_transits',
#'phot_rp_n_blended_transits', 'phot_proc_mode',
#'bp_rp', 'bp_g', 'g_rp',
#'radial_velocity', 'radial_velocity_error', 'rv_method_used', 'rv_nb_transits',
#'rv_nb_deblended_transits', 'rv_visibility_periods_used', 'rv_expected_sig_to_noise',
#'rv_renormalised_gof', 'rv_chisq_pvalue', 'rv_time_duration', 'rv_amplitude_robust',
#'rv_template_teff', 'rv_template_logg', 'rv_template_fe_h', 'rv_atm_param_origin',
#'vbroad', 'vbroad_error', 'vbroad_nb_transits', 'grvs_mag', 'grvs_mag_error',
#'grvs_mag_nb_transits', 'rvs_spec_sig_to_noise', 'phot_variable_flag',
#'l', 'b', 'ecl_lon', 'ecl_lat', 'in_qso_candidates', 'in_galaxy_candidates',
#'non_single_star', 'has_xp_continuous', 'has_xp_sampled', 'has_rvs',
#'has_epoch_photometry', 'has_epoch_rv', 'has_mcmc_gspphot', 'has_mcmc_msc',
#'in_andromeda_survey', 'classprob_dsc_combmod_quasar', 'classprob_dsc_combmod_galaxy',
#'classprob_dsc_combmod_star', 'teff_gspphot', 'teff_gspphot_lower',
#'teff_gspphot_upper', 'logg_gspphot', 'logg_gspphot_lower', 'logg_gspphot_upper',
#'mh_gspphot', 'mh_gspphot_lower', 'mh_gspphot_upper', 'distance_gspphot',
...
#'ebpminrp_gspphot_lower', 'ebpminrp_gspphot_upper', 'libname_gspphot', 'dist']#
